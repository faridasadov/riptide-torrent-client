...
const I18N = {
  en: {
    ...
    ipFilterDesc: "One CIDR or start–end range per line",
    vpnRoute: "Route traffic through VPN interface",
    vpnRouteDesc: "nftables kill-switch restricts client to tun0 and loopback only",
    authSetting: "Authentication",
    authSettingDesc: "Session cookie + Basic Auth API compatibility",
  ...
  az: {
    ...
    preferTcpDesc: "qBittorrent qarışıq rejimi ilə uyğundur", limitTcpOverhead: "TCP yük artımını azalt",
    ...
    anonymousMode: "Anonim rejim", ipFilter: "IP filtri",
    ipFilterDesc: "Hər sətirdə bir CIDR və ya başlanğıc–son aralığı",
    vpnRoute: "Trafiki VPN interfeysi üzərindən yönləndir",
    vpnRouteDesc: "nftables kill-switch klienti yalnız tun0 və loopback ilə məhdudlaşdırır",
    authSetting: "Autentifikasiya",
    authSettingDesc: "Session cookie + Basic Auth API uyğunluğu",
  ...
  ru: {
    ...
    preferTcpDesc: "Соответствует смешанному режиму qBittorrent", limitTcpOverhead: "Ограничить накладные расходы TCP",
    ...
    ipFilterDesc: "По одному CIDR или диапазону start–end в строке",
    vpnRoute: "Направить трафик через VPN-интерфейс",
    vpnRouteDesc: "nftables kill-switch ограничивает клиент интерфейсами tun0 и loopback",
    authSetting: "Аутентификация",
    authSettingDesc: "Cookie сессии + совместимость с Basic Auth API",
